...
<p align="center">
  <sub>Sample data — the screenshot is generated by
  <a href="scripts/generate-screenshot.mjs"><code>scripts/generate-screenshot.mjs</code></a>,
  never captured from a real mailbox.</sub>
</p>
